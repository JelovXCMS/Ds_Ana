...
DIR="/home/peng43/work/Project/Ds_PbPb/Ds_PbPbAna/Miscellaneous/sPlot_varCompare/BuildFitfile_PBS"   ## this is where loop.exe exist
...
do
	...
	Inputfile=$line
	Outputfile="$OUTPUTDIR/DsFitFile_$(basename ${Inputfile})_${fileCounter}.root"
	echo "Outputfile: $Outputfile"

	./BuildFitfile.exe $Inputfile $Outputfile $isPbPb
