...
void Compare_offMC_Gen_Dntuple(int PNP=0){

	InitStyle();
	gStyle->SetOptStat(0);
	gStyle->SetOptTitle(0);

	TFile *f_ori=TFile::Open("/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/PbPb_MC/Dntuple_PbPb_MC_Prompt_phikkpi_pt5p7.root","READ");
...
//	t_ntDs_ori->AddFriend(t_ntRoot_ori);
	...
	TFile *f_new=TFile::Open("/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offPbPb_MC/Ds_Prompt_phikkpi_pt6.root","READ");
