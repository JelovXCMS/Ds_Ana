...
// Fri Jul 20 12:42:21 2018 by ROOT version 6.02/13
// from TTree Events/
// found on file: /mnt/hadoop/store/group/hi/chengchi/Btest/Btest5TeV/Btest_step0_GEN/Btest_step0_GEN/180717_041826/0000/Btest_step0_GEN_306.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   const Int_t kMaxGenEventInfoProduct_generator__GEN = 1;
   const Int_t kMaxedmHepMCProduct_generator__GEN = 1;
   const Int_t kMaxedmRandomEngineStates_randomEngineStateProducer__GEN = 1;
   const Int_t kMaxedmTriggerResults_TriggerResults__GEN = 1;
   const Int_t kMaxints_genParticles__GEN = 1;
   const Int_t kMaxrecoGenJets_ak4GenJets__GEN = 1;
   const Int_t kMaxrecoGenJets_ak5GenJets__GEN = 1;
   const Int_t kMaxrecoGenJets_ak8GenJets__GEN = 1;
   const Int_t kMaxrecoGenJets_iterativeCone5GenJets__GEN = 1;
   const Int_t kMaxrecoGenJets_kt4GenJets__GEN = 1;
   const Int_t kMaxrecoGenJets_kt6GenJets__GEN = 1;
   const Int_t kMaxrecoGenMETs_genMetCalo__GEN = 1;
   const Int_t kMaxrecoGenMETs_genMetCaloAndNonPrompt__GEN = 1;
   const Int_t kMaxrecoGenMETs_genMetTrue__GEN = 1;
   const Int_t kMaxrecoGenParticles_genParticles__GEN = 1;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/hadoop/store/group/hi/chengchi/Btest/Btest5TeV/Btest_step0_GEN/Btest_step0_GEN/180717_041826/0000/Btest_step0_GEN_306.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/mnt/hadoop/store/group/hi/chengchi/Btest/Btest5TeV/Btest_step0_GEN/Btest_step0_GEN/180717_041826/0000/Btest_step0_GEN_306.root");
      }
