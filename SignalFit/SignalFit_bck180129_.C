...
int SignalFit(int isPbPb=0, int ibin_Dpt=6,int doMCstudySet=0, int doBkgVariationSet=1, int doSigVariationSet=1, int doCutScanSet=1){
...
*/
	...
	cout<<"SaveRootResult = "<<SaveRootResult<<endl;
