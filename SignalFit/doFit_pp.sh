...
# root -l -b -q 'SignalFit_wideRange.C++(0,'${i}')' >log/pp_pt${PTBIN[i]}to${PTBIN[i+1]}.log
root -l -b -q 'SignalFit_fixShapeCutScanV3.C++(0,'${i}')' >log/pp_pt${PTBIN[i]}to${PTBIN[i+1]}.log
i=$(($i+1))
done
