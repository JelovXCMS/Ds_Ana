...
*/
  ...
  massframe_pull->Draw();
	...
	SavePlotDirs(c_roofit_Data_pull[count_c_rootfit],Form("%s_Data_unbinfit_pull_pt%.0fto%.0f_%s%s_FixShape",str_PbPb.Data(),DptLow,DptHigh,extraName.Data(),extraName2.Data() ),savedirs );
  ...
  tl_roofitData->DrawLatexNDC(textposx+shiftX,textposy+shiftY,"|y|<1.0"); shiftY-=oneshift;
	...
	SavePlotDirs(c_roofit_Data[count_c_rootfit],Form("%s_Data_unbinfit_nopull_pt%.0fto%.0f_%s%s_FixShape",str_PbPb.Data(),DptLow,DptHigh,extraName.Data(),extraName2.Data() ),savedirs );
  ...
  massframe_pull->Draw();
	...
	SavePlotDirs(c_roofit_Data_withpull[count_c_rootfit],Form("%s_Data_unbinfit_pt%.0fto%.0f_%s%s_FixShape",str_PbPb.Data(),DptLow,DptHigh,extraName.Data(),extraName2.Data() ),savedirs );
  ...
  tl_roofitData->DrawLatexNDC(textposx+shiftX,textposy+shiftY,Form("BC pvale : %.2f",pvalue_BC)); shiftY-=oneshift;
	...
	SavePlotDirs(c_roofit_Data_withpull[count_c_rootfit],Form("%s_Data_unbinfit_pt%.0fto%.0f_%s%s_FixShape_withGOF",str_PbPb.Data(),DptLow,DptHigh,extraName.Data(),extraName2.Data() ),savedirs );
...
int SignalFit_fixShapeCutScan(int isPbPb=0, int ibin_Dpt=2,int doMCstudySet=0, int doBkgVariationSet=0, int doSigVariationSet=0, int doCutScanSet=0){
