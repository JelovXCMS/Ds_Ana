...
int SignalFit_SingleTask(int isPbPb=0, int ibin_Dpt=5,int doMCstudySet=0, int doBkgVariationSet=0, int doSigVariationSet=0, int doCutScanSet=1){

	Int_t SaveRootResult=1; 
