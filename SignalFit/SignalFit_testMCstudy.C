...
*/
	...
	// RooRealVar NumSig("NumSig","Number of Signal",N_sigV,-1e3,4e7);
	RooRealVar NumSig("NumSig","Number of Signal",N_sigV,0,4e7);
...
int SignalFit_testMCstudy(int isPbPb=0, int ibin_Dpt=7,int doMCstudySet=2, int doBkgVariationSet=0, int doSigVariationSet=0, int doCutScanSet=0){
