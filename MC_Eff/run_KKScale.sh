...
root -b -q 'MC_EffCalLoop_KKScale.C++ (0,0,0)' >log/pp_Prompt_phi.log  
root -b -q 'MC_EffCalLoop_KKScale.C++ (0,1,0)' >log/pp_NonPrompt_phi.log    
...
root -b -q 'MC_EffCalLoop_KKScale.C++ (3,0,0)' >log/PbPb_Prompt_phi.log  
root -b -q 'MC_EffCalLoop_KKScale.C++ (3,1,0)' >log/PbPb_NonPrompt_phi.log   
#echo "PbPb phi done"
