// adding KK width scale and Dalpha weight for Approval HW
...
// KKScale from Data/MC fit floatWidth, (MC cut should be cutWidth/scale to match data cut)
double KKScale=1;
double KKScaleDown=1;
double KKScaleUp=1;
double KKScale_use=1;

double KKScale_pp=1-0.0366737;
double KKScaleDown_pp=1-0.0366737-0.0166088; 
double KKScaleUp_pp=1-0.0366737+0.0166088; 

double KKScale_PbPb=1-0.0306056;
double KKScaleDown_PbPb=1-0.0366737-0.0112999; 
double KKScaleup_PbPb=1-0.0366737+0.0112999; 

TGraph *gr_Fitweight_PbPb_Dpt10to40;
TGraph *gr_Fitweight_PbPb_Dpt8to10;
TGraph *gr_Fitweight_PbPb_Dpt6to8;
TGraph *gr_Fitweight_pp_Dpt10to40;
TGraph *gr_Fitweight_pp_Dpt8to10;
TGraph *gr_Fitweight_pp_Dpt6to8;
TGraph *gr_Fitweight_pp_Dpt4to6;
TGraph *gr_Fitweight_pp_Dpt2to4;

double FitWtScl_MCP_PbPb_Dpt10to40;
double FitWtScl_MCP_PbPb_Dpt8to10;
double FitWtScl_MCP_PbPb_Dpt6to8;
double FitWtScl_MCP_pp_Dpt10to40;
double FitWtScl_MCP_pp_Dpt8to10;
double FitWtScl_MCP_pp_Dpt6to8;  
double FitWtScl_MCP_pp_Dpt4to6;  
double FitWtScl_MCP_pp_Dpt2to4;      

double FitWtScl_MCNP_PbPb_Dpt10to40;
double FitWtScl_MCNP_PbPb_Dpt8to10;
double FitWtScl_MCNP_PbPb_Dpt6to8;
double FitWtScl_MCNP_pp_Dpt10to40;
double FitWtScl_MCNP_pp_Dpt8to10;
double FitWtScl_MCNP_pp_Dpt6to8;  
double FitWtScl_MCNP_pp_Dpt4to6;  
double FitWtScl_MCNP_pp_Dpt2to4;  



TGraphErrors *gr_Ddls_weight_PbPb_Dpt10to40;
TGraphErrors *gr_Ddls_weight_PbPb_Dpt8to10;
TGraphErrors *gr_Ddls_weight_PbPb_Dpt6to8;
TGraphErrors *gr_Ddls_weight_pp_Dpt10to40;
TGraphErrors *gr_Ddls_weight_pp_Dpt8to10;
TGraphErrors *gr_Ddls_weight_pp_Dpt6to8;
TGraphErrors *gr_Ddls_weight_pp_Dpt4to6;
TGraphErrors *gr_Ddls_weight_pp_Dpt2to4;

double Ddls_WtScl_MCP_PbPb_Dpt10to40;
double Ddls_WtScl_MCP_PbPb_Dpt8to10;
double Ddls_WtScl_MCP_PbPb_Dpt6to8;
double Ddls_WtScl_MCP_pp_Dpt10to40;
double Ddls_WtScl_MCP_pp_Dpt8to10;
double Ddls_WtScl_MCP_pp_Dpt6to8;  
double Ddls_WtScl_MCP_pp_Dpt4to6;  
double Ddls_WtScl_MCP_pp_Dpt2to4;      

double Ddls_WtScl_MCNP_PbPb_Dpt10to40;
double Ddls_WtScl_MCNP_PbPb_Dpt8to10;
double Ddls_WtScl_MCNP_PbPb_Dpt6to8;
double Ddls_WtScl_MCNP_pp_Dpt10to40;
double Ddls_WtScl_MCNP_pp_Dpt8to10;
double Ddls_WtScl_MCNP_pp_Dpt6to8;  
double Ddls_WtScl_MCNP_pp_Dpt4to6;  
double Ddls_WtScl_MCNP_pp_Dpt2to4;  
...
Double_t DdlsWt(double Ddls, double Dpt, int isPbPb=0,int PNPrompt=0){

	TGraph *gr_wt=nullptr;
	double WtScl=0;
	if(isPbPb==0){
		if(Dpt>=2 && Dpt<4){
			gr_wt=gr_Ddls_weight_pp_Dpt2to4;
			WtScl=Ddls_WtScl_MCP_pp_Dpt2to4;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_pp_Dpt2to4;}
		}else if(Dpt>=4 && Dpt<6){
			gr_wt=gr_Ddls_weight_pp_Dpt4to6;
			WtScl=Ddls_WtScl_MCP_pp_Dpt4to6;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_pp_Dpt4to6;}
		}else if(Dpt>=6 && Dpt<8){
			gr_wt=gr_Ddls_weight_pp_Dpt6to8;
			WtScl=Ddls_WtScl_MCP_pp_Dpt6to8;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_pp_Dpt6to8;}
		}else if(Dpt>=8 && Dpt<10){
			gr_wt=gr_Ddls_weight_pp_Dpt8to10;
			WtScl=Ddls_WtScl_MCP_pp_Dpt8to10;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_pp_Dpt8to10;}
		}else if(Dpt>=10 && Dpt<40){
			gr_wt=gr_Ddls_weight_pp_Dpt10to40;
			WtScl=Ddls_WtScl_MCP_pp_Dpt10to40;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_pp_Dpt10to40;}
		}
	}else if(isPbPb){
		if(Dpt>=6 && Dpt<8){
			gr_wt=gr_Ddls_weight_PbPb_Dpt6to8;
			WtScl=Ddls_WtScl_MCP_PbPb_Dpt6to8;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_PbPb_Dpt6to8;}
		}else if(Dpt>=8 && Dpt<10){
			gr_wt=gr_Ddls_weight_PbPb_Dpt8to10;
			WtScl=Ddls_WtScl_MCP_PbPb_Dpt8to10;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_PbPb_Dpt8to10;}
		}else if(Dpt>=10 && Dpt<40){
			gr_wt=gr_Ddls_weight_PbPb_Dpt10to40;
			WtScl=Ddls_WtScl_MCP_PbPb_Dpt10to40;
			if(PNPrompt){WtScl=Ddls_WtScl_MCNP_PbPb_Dpt10to40;}
		}
...
Double_t DalphaWt(double Dalpha, double Dpt, int isPbPb=0,int PNPrompt=0){

	TGraph *gr_wt=nullptr;
	double WtScl=0;
	if(isPbPb==0){
		if(Dpt>=2 && Dpt<4){
			gr_wt=gr_Fitweight_pp_Dpt2to4;
			WtScl=FitWtScl_MCP_pp_Dpt2to4;
			if(PNPrompt){WtScl=FitWtScl_MCNP_pp_Dpt2to4;}
		}else if(Dpt>=4 && Dpt<6){
			gr_wt=gr_Fitweight_pp_Dpt4to6;
			WtScl=FitWtScl_MCP_pp_Dpt4to6;
			if(PNPrompt){WtScl=FitWtScl_MCNP_pp_Dpt4to6;}
		}else if(Dpt>=6 && Dpt<8){
			gr_wt=gr_Fitweight_pp_Dpt6to8;
			WtScl=FitWtScl_MCP_pp_Dpt6to8;
			if(PNPrompt){WtScl=FitWtScl_MCNP_pp_Dpt6to8;}
		}else if(Dpt>=8 && Dpt<10){
			gr_wt=gr_Fitweight_pp_Dpt8to10;
			WtScl=FitWtScl_MCP_pp_Dpt8to10;
			if(PNPrompt){WtScl=FitWtScl_MCNP_pp_Dpt8to10;}
		}else if(Dpt>=10 && Dpt<40){
			gr_wt=gr_Fitweight_pp_Dpt10to40;
			WtScl=FitWtScl_MCP_pp_Dpt10to40;
			if(PNPrompt){WtScl=FitWtScl_MCNP_pp_Dpt10to40;}
		}
	}else if(isPbPb){
		if(Dpt>=6 && Dpt<8){
			gr_wt=gr_Fitweight_PbPb_Dpt6to8;
			WtScl=FitWtScl_MCP_PbPb_Dpt6to8;
			if(PNPrompt){WtScl=FitWtScl_MCNP_PbPb_Dpt6to8;}
		}else if(Dpt>=8 && Dpt<10){
			gr_wt=gr_Fitweight_PbPb_Dpt8to10;
			WtScl=FitWtScl_MCP_PbPb_Dpt8to10;
			if(PNPrompt){WtScl=FitWtScl_MCNP_PbPb_Dpt8to10;}
		}else if(Dpt>=10 && Dpt<40){
			gr_wt=gr_Fitweight_PbPb_Dpt10to40;
			WtScl=FitWtScl_MCP_PbPb_Dpt10to40;
			if(PNPrompt){WtScl=FitWtScl_MCNP_PbPb_Dpt10to40;}
		}
	...
	if(gr_wt){
		Dalphawt=gr_wt->Eval(Dalpha)*WtScl;
	}
...
Int_t Selection(DsMinTreeLoad &DsClass, Int_t ibin_Dpt=0, Int_t isPbPb=0, Bool_t REAL=true,Int_t PNPrompt=0 ,Int_t DsGenTrue=23333, Bool_t doVarScan=false, TString Var="Dalpha", Int_t ibin_Var=0, Bool_t looseCut=false){
	...
	double PhimassCutWidth=DtktkResmassCutWidth/KKScale_use;
...
int MC_EffCalLoop_KKScale(int isPbPb=3, int PNPrompt = 0, int DsChannel=0  ){
	...
	// read Dalpha weight
	TFile *f_Dalpha_Weight=TFile::Open("/home/peng43/work/Project/Ds_PbPb/Ds_PbPbAna/ARC_HW/sPlot_varCompare_forApproval_Dalpha/MergeWeight_Dalpha.root","read");
	gr_Fitweight_PbPb_Dpt10to40=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_PbPb_Dpt10to40");
	gr_Fitweight_PbPb_Dpt8to10=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_PbPb_Dpt8to10");
	gr_Fitweight_PbPb_Dpt6to8=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_PbPb_Dpt6to8");
	gr_Fitweight_pp_Dpt10to40=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_pp_Dpt10to40");
	gr_Fitweight_pp_Dpt8to10=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_pp_Dpt8to10");
	gr_Fitweight_pp_Dpt6to8=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_pp_Dpt6to8");
	gr_Fitweight_pp_Dpt4to6=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_pp_Dpt4to6");
	gr_Fitweight_pp_Dpt2to4=(TGraph*)f_Dalpha_Weight->Get("gr_Fitweight_pp_Dpt2to4");

	TH1D *h_MCNP_FitWtScale_PbPb_Dpt6to8=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_PbPb_Dpt6to8");
	TH1D *h_MCNP_FitWtScale_PbPb_Dpt8to10=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_PbPb_Dpt8to10");
	TH1D *h_MCNP_FitWtScale_PbPb_Dpt10to40=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_PbPb_Dpt10to40");

	TH1D *h_MCNP_FitWtScale_pp_Dpt2to4=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_pp_Dpt2to4");
	TH1D *h_MCNP_FitWtScale_pp_Dpt4to6=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_pp_Dpt4to6");
	TH1D *h_MCNP_FitWtScale_pp_Dpt6to8=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_pp_Dpt6to8");
	TH1D *h_MCNP_FitWtScale_pp_Dpt8to10=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_pp_Dpt8to10");
	TH1D *h_MCNP_FitWtScale_pp_Dpt10to40=(TH1D*)f_Dalpha_Weight->Get("h_MCNP_FitWtScale_pp_Dpt10to40");

	FitWtScl_MCNP_PbPb_Dpt10to40=h_MCNP_FitWtScale_PbPb_Dpt10to40->GetBinContent(1);
	FitWtScl_MCNP_PbPb_Dpt8to10= h_MCNP_FitWtScale_PbPb_Dpt8to10->GetBinContent(1);
	FitWtScl_MCNP_PbPb_Dpt6to8=  h_MCNP_FitWtScale_PbPb_Dpt6to8->GetBinContent(1);
	FitWtScl_MCNP_pp_Dpt10to40=  h_MCNP_FitWtScale_pp_Dpt10to40->GetBinContent(1);
	FitWtScl_MCNP_pp_Dpt8to10=   h_MCNP_FitWtScale_pp_Dpt8to10->GetBinContent(1);
	FitWtScl_MCNP_pp_Dpt6to8=    h_MCNP_FitWtScale_pp_Dpt6to8->GetBinContent(1);
	FitWtScl_MCNP_pp_Dpt4to6=    h_MCNP_FitWtScale_pp_Dpt4to6->GetBinContent(1);
	FitWtScl_MCNP_pp_Dpt2to4=    h_MCNP_FitWtScale_pp_Dpt2to4->GetBinContent(1);   

	TH1D *h_MCP_FitWtScale_PbPb_Dpt6to8=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_PbPb_Dpt6to8");
	TH1D *h_MCP_FitWtScale_PbPb_Dpt8to10=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_PbPb_Dpt8to10");
	TH1D *h_MCP_FitWtScale_PbPb_Dpt10to40=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_PbPb_Dpt10to40");

	TH1D *h_MCP_FitWtScale_pp_Dpt2to4=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_pp_Dpt2to4");
	TH1D *h_MCP_FitWtScale_pp_Dpt4to6=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_pp_Dpt4to6");
	TH1D *h_MCP_FitWtScale_pp_Dpt6to8=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_pp_Dpt6to8");
	TH1D *h_MCP_FitWtScale_pp_Dpt8to10=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_pp_Dpt8to10");
	TH1D *h_MCP_FitWtScale_pp_Dpt10to40=(TH1D*)f_Dalpha_Weight->Get("h_MCP_FitWtScale_pp_Dpt10to40");

	FitWtScl_MCP_PbPb_Dpt10to40=h_MCP_FitWtScale_PbPb_Dpt10to40->GetBinContent(1);
	FitWtScl_MCP_PbPb_Dpt8to10= h_MCP_FitWtScale_PbPb_Dpt8to10->GetBinContent(1);
	FitWtScl_MCP_PbPb_Dpt6to8=  h_MCP_FitWtScale_PbPb_Dpt6to8->GetBinContent(1);
	FitWtScl_MCP_pp_Dpt10to40=  h_MCP_FitWtScale_pp_Dpt10to40->GetBinContent(1);
	FitWtScl_MCP_pp_Dpt8to10=   h_MCP_FitWtScale_pp_Dpt8to10->GetBinContent(1);
	FitWtScl_MCP_pp_Dpt6to8=    h_MCP_FitWtScale_pp_Dpt6to8->GetBinContent(1);
	FitWtScl_MCP_pp_Dpt4to6=    h_MCP_FitWtScale_pp_Dpt4to6->GetBinContent(1);
	FitWtScl_MCP_pp_Dpt2to4=    h_MCP_FitWtScale_pp_Dpt2to4->GetBinContent(1);   



	// read Ddls weight
	TFile *f_Ddls_Weight=TFile::Open("/home/peng43/work/Project/Ds_PbPb/Ds_PbPbAna/ARC_HW/sPlot_varCompare_forApproval_Dalpha/MergeWeight_Ddls.root","read");
	gr_Ddls_weight_PbPb_Dpt10to40=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_PbPb_Dpt10to40");
	gr_Ddls_weight_PbPb_Dpt8to10=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_PbPb_Dpt8to10");
	gr_Ddls_weight_PbPb_Dpt6to8=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_PbPb_Dpt6to8");
	gr_Ddls_weight_pp_Dpt10to40=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_pp_Dpt10to40");
	gr_Ddls_weight_pp_Dpt8to10=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_pp_Dpt8to10");
	gr_Ddls_weight_pp_Dpt6to8=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_pp_Dpt6to8");
	gr_Ddls_weight_pp_Dpt4to6=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_pp_Dpt4to6");
	gr_Ddls_weight_pp_Dpt2to4=(TGraphErrors*)f_Ddls_Weight->Get("gr_weight_pp_Dpt2to4");

	TH1D *h_MCNP_WtScale_PbPb_Dpt6to8=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_PbPb_Dpt6to8");
	TH1D *h_MCNP_WtScale_PbPb_Dpt8to10=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_PbPb_Dpt8to10");
	TH1D *h_MCNP_WtScale_PbPb_Dpt10to40=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_PbPb_Dpt10to40");

	TH1D *h_MCNP_WtScale_pp_Dpt2to4=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_pp_Dpt2to4");
	TH1D *h_MCNP_WtScale_pp_Dpt4to6=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_pp_Dpt4to6");
	TH1D *h_MCNP_WtScale_pp_Dpt6to8=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_pp_Dpt6to8");
	TH1D *h_MCNP_WtScale_pp_Dpt8to10=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_pp_Dpt8to10");
	TH1D *h_MCNP_WtScale_pp_Dpt10to40=(TH1D*)f_Ddls_Weight->Get("h_MCNP_WtScale_pp_Dpt10to40");

	Ddls_WtScl_MCNP_PbPb_Dpt10to40=h_MCNP_WtScale_PbPb_Dpt10to40->GetBinContent(1);
	Ddls_WtScl_MCNP_PbPb_Dpt8to10= h_MCNP_WtScale_PbPb_Dpt8to10->GetBinContent(1);
	Ddls_WtScl_MCNP_PbPb_Dpt6to8=  h_MCNP_WtScale_PbPb_Dpt6to8->GetBinContent(1);
	Ddls_WtScl_MCNP_pp_Dpt10to40=  h_MCNP_WtScale_pp_Dpt10to40->GetBinContent(1);
	Ddls_WtScl_MCNP_pp_Dpt8to10=   h_MCNP_WtScale_pp_Dpt8to10->GetBinContent(1);
	Ddls_WtScl_MCNP_pp_Dpt6to8=    h_MCNP_WtScale_pp_Dpt6to8->GetBinContent(1);
	Ddls_WtScl_MCNP_pp_Dpt4to6=    h_MCNP_WtScale_pp_Dpt4to6->GetBinContent(1);
	Ddls_WtScl_MCNP_pp_Dpt2to4=    h_MCNP_WtScale_pp_Dpt2to4->GetBinContent(1);   

	TH1D *h_MCP_WtScale_PbPb_Dpt6to8=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_PbPb_Dpt6to8");
	TH1D *h_MCP_WtScale_PbPb_Dpt8to10=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_PbPb_Dpt8to10");
	TH1D *h_MCP_WtScale_PbPb_Dpt10to40=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_PbPb_Dpt10to40");

	TH1D *h_MCP_WtScale_pp_Dpt2to4=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_pp_Dpt2to4");
	TH1D *h_MCP_WtScale_pp_Dpt4to6=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_pp_Dpt4to6");
	TH1D *h_MCP_WtScale_pp_Dpt6to8=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_pp_Dpt6to8");
	TH1D *h_MCP_WtScale_pp_Dpt8to10=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_pp_Dpt8to10");
	TH1D *h_MCP_WtScale_pp_Dpt10to40=(TH1D*)f_Ddls_Weight->Get("h_MCP_WtScale_pp_Dpt10to40");

	Ddls_WtScl_MCP_PbPb_Dpt10to40=h_MCP_WtScale_PbPb_Dpt10to40->GetBinContent(1);
	Ddls_WtScl_MCP_PbPb_Dpt8to10= h_MCP_WtScale_PbPb_Dpt8to10->GetBinContent(1);
	Ddls_WtScl_MCP_PbPb_Dpt6to8=  h_MCP_WtScale_PbPb_Dpt6to8->GetBinContent(1);
	Ddls_WtScl_MCP_pp_Dpt10to40=  h_MCP_WtScale_pp_Dpt10to40->GetBinContent(1);
	Ddls_WtScl_MCP_pp_Dpt8to10=   h_MCP_WtScale_pp_Dpt8to10->GetBinContent(1);
	Ddls_WtScl_MCP_pp_Dpt6to8=    h_MCP_WtScale_pp_Dpt6to8->GetBinContent(1);
	Ddls_WtScl_MCP_pp_Dpt4to6=    h_MCP_WtScale_pp_Dpt4to6->GetBinContent(1);
	Ddls_WtScl_MCP_pp_Dpt2to4=    h_MCP_WtScale_pp_Dpt2to4->GetBinContent(1);   
	...
	/*
	cout<<"Dalpha weight"<<endl;
	cout<<DdlsWt(0.1,8,3,0)<<endl;
	cout<<DdlsWt(0.1,8,3,1)<<endl;
	cout<<DdlsWt(0.1,12,3,0)<<endl;
	cout<<DdlsWt(0.1,12,3,1)<<endl;

	cout<<DdlsWt(0.1,8,0,0)<<endl;
	cout<<DdlsWt(0.1,8,0,1)<<endl;
	cout<<DdlsWt(0.1,12,0,0)<<endl;
	cout<<DdlsWt(0.1,12,0,1)<<endl;
	...
	*/
	...
	KKScale=KKScale_pp;
	KKScaleDown=KKScaleDown_pp;
	KKScaleUp=KKScaleDown_pp;
	if(isPbPb){
		KKScale=KKScale_PbPb;
		KKScaleDown=KKScaleDown_PbPb;
		KKScaleUp=KKScaleDown_PbPb;
	}
	KKScale_use=1;	
	...
	// KKScale
	TH1D *h_RecoNormEff_KKScl = new TH1D("h_RecoNormEff_KKScl","h_RecoNormEff_KKScl",nbin_pt,bins_pt); h_RecoNormEff_KKScl->Sumw2();
	TH1D *h_RecoNorm_KKScl = new TH1D("h_RecoNorm_KKScl","h_RecoNorm_KKScl",nbin_pt,bins_pt); h_RecoNorm_KKScl->Sumw2();

	TH1D *h_RecoNormEff_KKSclUp = new TH1D("h_RecoNormEff_KKSclUp","h_RecoNormEff_KKSclUp",nbin_pt,bins_pt); h_RecoNormEff_KKSclUp->Sumw2();
	TH1D *h_RecoNorm_KKSclUp = new TH1D("h_RecoNorm_KKSclUp","h_RecoNorm_KKSclUp",nbin_pt,bins_pt); h_RecoNorm_KKSclUp->Sumw2();

	TH1D *h_RecoNormEff_KKSclDown = new TH1D("h_RecoNormEff_KKSclDown","h_RecoNormEff_KKSclDown",nbin_pt,bins_pt); h_RecoNormEff_KKSclDown->Sumw2();
	TH1D *h_RecoNorm_KKSclDown = new TH1D("h_RecoNorm_KKSclDown","h_RecoNorm_KKSclDown",nbin_pt,bins_pt); h_RecoNorm_KKSclDown->Sumw2();


	// Dalpha Weight
	TH1D *h_RecoNormEff_DalphaWt = new TH1D("h_RecoNormEff_DalphaWt","h_RecoNormEff_DalphaWt",nbin_pt,bins_pt); h_RecoNormEff_DalphaWt->Sumw2();
	TH1D *h_RecoNorm_DalphaWt = new TH1D("h_RecoNorm_DalphaWt","h_RecoNorm_DalphaWt",nbin_pt,bins_pt); h_RecoNorm_DalphaWt->Sumw2();


	// Ddls Weight
	TH1D *h_RecoNormEff_DdlsWt = new TH1D("h_RecoNormEff_DdlsWt","h_RecoNormEff_DdlsWt",nbin_pt,bins_pt); h_RecoNormEff_DdlsWt->Sumw2();
	TH1D *h_RecoNorm_DdlsWt = new TH1D("h_RecoNorm_DdlsWt","h_RecoNorm_DdlsWt",nbin_pt,bins_pt); h_RecoNorm_DdlsWt->Sumw2();
	...
	for(Long64_t ientry=0 ; ientry<nentries_Reco; ientry++){
		...
		if( Selection(DsMCReco , -1 , isPbPb, REAL, PNPrompt, DsGenTrue, false,"",0,false) == 1 ) {
			...
			// DalphaWt
			h_RecoNorm_DalphaWt->Fill(DsMCReco.Dpt, D0DataWeight*DalphaWt(DsMCReco.Dalpha, DsMCReco.Dpt, isPbPb, PNPrompt ) );
			h_RecoNorm_DdlsWt->Fill(DsMCReco.Dpt, D0DataWeight*DdlsWt(DsMCReco.Ddls_BestScale, DsMCReco.Dpt, isPbPb, PNPrompt ) );
			//Double_t DalphaWt(double Dalpha, double Dpt, int isPbPb=0,int PNPrompt=0)
		}

		// KKScales : no scale, scale donw, scale up, reset
		KKScale_use=KKScale; 
		if( Selection(DsMCReco , -1 , isPbPb, REAL, PNPrompt, DsGenTrue, false,"",0,false) == 1 ) {
			// cout<<"pass cut , Dpt ="<<DsMCReco.Dpt<<endl; 
			h_RecoNorm_KKScl->Fill(DsMCReco.Dpt, D0DataWeight);
		}
		KKScale_use=KKScaleUp; 
		if( Selection(DsMCReco , -1 , isPbPb, REAL, PNPrompt, DsGenTrue, false,"",0,false) == 1 ) {
			// cout<<"pass cut , Dpt ="<<DsMCReco.Dpt<<endl; 
			h_RecoNorm_KKSclUp->Fill(DsMCReco.Dpt, D0DataWeight);
		}
		KKScale_use=KKScaleDown; 
		if( Selection(DsMCReco , -1 , isPbPb, REAL, PNPrompt, DsGenTrue, false,"",0,false) == 1 ) {
			// cout<<"pass cut , Dpt ="<<DsMCReco.Dpt<<endl; 
			h_RecoNorm_KKSclDown->Fill(DsMCReco.Dpt, D0DataWeight);
		}

		KKScale_use=KKScale; // reset KKScale to default
		KKScale_use=1; // reset KKScale to default
	...
	// KK scales
	h_RecoNorm_KKScl->Write("",TObject::kOverwrite);
	h_RecoNormEff_KKScl->Divide(h_RecoNorm_KKScl, h_GenAll, 1,1,"B"); h_RecoNormEff_KKScl->SetTitle("h_RecoNormEff_KKScl"); h_RecoNormEff_KKScl->Write("",TObject::kOverwrite);

	h_RecoNorm_KKSclUp->Write("",TObject::kOverwrite);
	h_RecoNormEff_KKSclUp->Divide(h_RecoNorm_KKSclUp, h_GenAll, 1,1,"B"); h_RecoNormEff_KKSclUp->SetTitle("h_RecoNormEff_KKSclUp"); h_RecoNormEff_KKSclUp->Write("",TObject::kOverwrite);

	h_RecoNorm_KKSclDown->Write("",TObject::kOverwrite);
	h_RecoNormEff_KKSclDown->Divide(h_RecoNorm_KKSclDown, h_GenAll, 1,1,"B"); h_RecoNormEff_KKSclDown->SetTitle("h_RecoNormEff_KKSclDown"); h_RecoNormEff_KKSclDown->Write("",TObject::kOverwrite);

	// Dalpha Weight
	h_RecoNorm_DalphaWt->Write("",TObject::kOverwrite);
	h_RecoNormEff_DalphaWt->Divide(h_RecoNorm_DalphaWt, h_GenAll, 1,1,"B"); h_RecoNormEff_DalphaWt->SetTitle("h_RecoNormEff_DalphaWt"); h_RecoNormEff_DalphaWt->Write("",TObject::kOverwrite);

	// Ddls Weight
	h_RecoNorm_DdlsWt->Write("",TObject::kOverwrite);
	h_RecoNormEff_DdlsWt->Divide(h_RecoNorm_DdlsWt, h_GenAll, 1,1,"B"); h_RecoNormEff_DdlsWt->SetTitle("h_RecoNormEff_DdlsWt"); h_RecoNormEff_DdlsWt->Write("",TObject::kOverwrite);
