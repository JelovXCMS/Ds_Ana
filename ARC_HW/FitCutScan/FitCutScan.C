...
int FitCutScan(int isPbPb=0, double DptLow=6, double DptHigh=40, TString var_scan="Dchi2cl", double scan_val=0.05, int FixShape=0, double shapeVal=3.0 ){
  ...
  // }
	...
	TFile *fout=TFile::Open(Form("./fitout/%s/%s_%sDpt%.0fto%.0f_%s%.0f.root",var_scan.Data(),s_PbPb.Data(),s_FixShape.Data(),DptLow,DptHigh,var_scan.Data(),scan_val*100),"recreate");
	...
	c_MC->SaveAs(Form("./plots/%s/%s_MC%s_Dpt%.0fto%.0f_%s%.0f.png",var_scan.Data(),s_PbPb.Data(),s_FixShape.Data(),DptLow,DptHigh,var_scan.Data(),scan_val*100));
 ...
 TPad *pad1 = new TPad("pad1","top pad",0.0,0.25,1.0,1.0);
  ...
  Lp1->Draw("same");
	...
	c_data->SaveAs(Form("./plots/%s/%s_Data%s_Dpt%.0fto%.0f_%s%.0f.png",var_scan.Data(),s_PbPb.Data(),s_FixShape.Data(),DptLow,DptHigh,var_scan.Data(),scan_val*100));
...
int main(int argc, char*argv[]){
	...
	//int FitCutScan(int isPbPb=0, double DptLow=6, double DptHigh=40, TString var_scan="Ddls", double scan_val=3.0, TString scanType="larger",int FixShape=0, double shapeVal=3.0 )
	cout<<"argc = "<<argc<<endl;
	...
	if(argc==6){
		FitCutScan(atoi(argv[1]), atof(argv[2]), atof(argv[3]), argv[4], atof(argv[5]) );	
	}else if(argc==8){
		FitCutScan(atoi(argv[1]), atof(argv[2]), atof(argv[3]), argv[4], atof(argv[5]), atoi(argv[6]), atof(argv[7]) );	
	}else{
