...
int FitMkk_pre(int isPbPb=0, double DptLow=2, double DptHigh=40, int useBkgSubData=0, double DVtxPCut=0.25, double DdlsCut=4.5){
...
//  tl_binfitData->DrawLatexNDC(textposx+0.28,textposy+shiftY,Form("%s_Data_binfit",str_PbPb.Data()));  shiftY-=oneshift;
 ...
 SavePlotDirs(c_roofit_Data,Form("%s_Data_Mkk_roofit%s_pre",s_type.Data(),s_BkgSub.Data() ),{"PhiRatio"},"gcf");
