...
TLatex *texCmsPreFun(double x=0.15, double y=tex_upperY, TString stex="#scale[1.25]{CMS} #it{Preliminary}"){
  TLatex* texCmsPre = new TLatex(x,y, stex.Data());
...
void RAA_pre(int startbin=1){
  ...
  TLatex* texCms = new TLatex(0.20,tex_upperY-0.08, "#scale[1.25]{#bf{CMS}}");
  texCms->SetNDC();
  ...
  TLatex* texPre2 = new TLatex(0.20,tex_upperY-0.14, "#it{Preliminary}");
  texPre2->SetNDC();
...
// gStyle->SetOptStat(0);
  ...
  // gStyle->SetOptStat(0);
	...
	SavePlotDirs(c_DsOverD0,"DsOverD0",{"Result_pre"});
  ...
  SavePlotDirs(c_DsD0_DRatio,"DsD0_DRatio",{"Result_pre"});
...
*/
  ...
  h_DsoverD0_DRatio_Sys->GetYaxis()->SetTitleOffset(0.58);
	...
	SavePlotDirs(c_DsOverD0_withDRatio,"DsOverD0_withDRatio_pre",{"Result_pre"},"cf");
...
//	h_RAA->SetFillStyle(3004);
  ...
  le_RAA->AddEntry(h_RAA,"R_{AA} 0-100%","flp");
	...
	SavePlotDirs(c_RAA,"RAA_pre",{"Result_pre"},"cf");
  ...
  // gStyle->SetOptStat(0);
	...
	SavePlotDirs(c_CSdNdpt,"CSdNdpt_pre",{"Result_pre"},"cf");
  ...
  // gStyle->SetOptStat(0);
	...
	SavePlotDirs(c_CSdNdpt_ratio,"CSdNdpt_ratio_pre",{"Result_pre"},"cf");
...
*/
  ...
  // gStyle->SetOptStat(0);
	...
	SavePlotDirs(c_DsOverD0_Alice,"DsOverD0_Alice",{"Result_pre"});
...
//	le_DsD0Alice->Draw("SAME");
  ...
  h_DsoverD0_DRatio_Sys->GetYaxis()->SetTitleOffset(0.58);
	...
	SavePlotDirs(c_DsOverD0_withDRatio_Alice,"DsOverD0_withDRatioAlice",{"Result_pre"});
...
*/
  ...
  le_RAA_Alice->AddEntry(h_RAA,"R_{AA} 0-100%","flp");
	...
	SavePlotDirs(c_RAA_Alice,"RAA_Alice",{"Result_pre"});
