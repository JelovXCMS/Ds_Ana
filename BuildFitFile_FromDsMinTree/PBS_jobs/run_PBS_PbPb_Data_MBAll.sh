...
OUTPUTDIR=/scratch/halstead/p/peng43/Ds_phikkpi/BuildFitFile_FromDsMinTree/PbPb3_Data_moreScan/
JobIndex=BuildFit_PbPb3
FilePerJob=200
...
for i in {1..11}
	do
	../submit_PBS_job_mutltifiles.sh input_list/Ds_PbPb_Data_HIMB${i}_TrkOnly.lis  $isPbPb $FilePerJob $OUTPUTDIR/HIMB${i}_TrkOnly/ HIMB${i}TrkOnly${JobIndex}  $isReal
done
