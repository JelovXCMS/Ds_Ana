...
../submit_PBS_job_mutltifiles.sh input_list/CMStune_CharmAll_softQCD.lis  $isPbPb $FilePerJob /scratch/halstead/p/peng43/Ds_phikkpi/CS_CharmAll_softQCD CS_wholeTable_softQCD  $isReal
