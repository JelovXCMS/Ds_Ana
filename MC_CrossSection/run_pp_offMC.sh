...
root -b -l -q 'MakeDsMinTree.C++ ("/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC/DsNtuple_pp_Prompt_Phi_pt2.root" ,"output/DsMinTree_pp_offMC_Ds_Prompt_phikkpi_pt2.root", 0 ,0)'
