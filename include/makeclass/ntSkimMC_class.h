...
// Thu Mar  1 17:34:48 2018 by ROOT version 6.02/13
// from TTree ntSkim/
// found on file: Ds_phikkpi_pt4.root
//////////////////////////////////////////////////////////

#ifndef ntSkimMC_class_h
#define ntSkimMC_class_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ntSkimMC_class(TTree *tree=0);
   virtual ~ntSkimMC_class();
...
#ifdef ntSkimMC_class_cxx
ntSkimMC_class::ntSkimMC_class(TTree *tree) : fChain(0) 
{
...
ntSkimMC_class::~ntSkimMC_class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ntSkimMC_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ntSkimMC_class::LoadTree(Long64_t entry)
{
...
void ntSkimMC_class::Init(TTree *tree)
{
...
void ntSkimMC_class::Show(Long64_t entry)
{
...
Int_t ntSkimMC_class::Cut(Long64_t entry)
{
...
#endif // #ifdef ntSkimMC_class_cxx
