...
mkdir -p /scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_nocut/
...
#	echo "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC/Ds_pp_MC_Prompt_Phi_pt${ptbins[i]}.root"
	./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC_nocut/Ds_pp_MC_Prompt_Phi_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_nocut/DsMinTree_pp_offMC_Prompt_Phi_pt${ptbins[i]}.root" 0 0
	./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC_nocut/Ds_pp_MC_NonPrompt_Phi_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_nocut/DsMinTree_pp_offMC_NonPrompt_Phi_pt${ptbins[i]}.root" 0 0
	# ./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC_nocut/Ds_pp_MC_Prompt_f0_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_nocut/DsMinTree_pp_offMC_Prompt_f0_pt${ptbins[i]}.root" 0 0
	# ./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC_nocut/Ds_pp_MC_NonPrompt_f0_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_nocut/DsMinTree_pp_offMC_NonPrompt_f0_pt${ptbins[i]}.root" 0 0
