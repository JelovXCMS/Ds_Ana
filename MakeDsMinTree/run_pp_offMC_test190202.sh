...
rm MakeDsMinTree_ForDdlsPVE.exe
g++ MakeDsMinTree_ForDdlsPVE.C $(root-config --cflags --libs) -Wall -O2 -o MakeDsMinTree_ForDdlsPVE.exe
...
echo here
	...
	./MakeDsMinTree_ForDdlsPVE.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC/Ds_pp_MC_Prompt_Phi_pt6.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_test190202/DsMinTree_pp_offMC_Prompt_Phi_pt6.root" 0 0
#for i in {0..5}
#do
#	echo $i
...
#	./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC/Ds_pp_MC_Prompt_Phi_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_test190202/DsMinTree_pp_offMC_Prompt_Phi_pt${ptbins[i]}.root" 0 0
#	./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC/Ds_pp_MC_NonPrompt_Phi_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_test190202/DsMinTree_pp_offMC_NonPrompt_Phi_pt${ptbins[i]}.root" 0 0
#	./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC/Ds_pp_MC_Prompt_f0_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_test190202/DsMinTree_pp_offMC_Prompt_f0_pt${ptbins[i]}.root" 0 0
#	./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/offpp_MC/Ds_pp_MC_NonPrompt_f0_pt${ptbins[i]}.root" "/scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_offMC_test190202/DsMinTree_pp_offMC_NonPrompt_f0_pt${ptbins[i]}.root" 0 0
