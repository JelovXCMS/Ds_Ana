...
DIR="/home/peng43/work/Project/Ds_PbPb/Ds_PbPbAna/MakeDsMinTree"
...
# make the PBS file
cat > PBS_jobs/PBS_shAll/PBS_${STARTFILE}to${ENDFILE}_${JobIndex}_V2.sh <<EOF
#!/bin/sh

#PBS -l nodes=1,walltime=04:00:00,mem=2400MB
#PBS -N Dnt${STARTFILE}to${ENDFILE}_${JobIndex}
#PBS -o ${DIR}/PBS_jobs/PBS_log/PBS_${STARTFILE}to${ENDFILE}_${JobIndex}_V2.log
#PBS -e ${DIR}/PBS_jobs/PBS_log/PBS_${STARTFILE}to${ENDFILE}_${JobIndex}_V2.err
#PBS -r n
#PBS -V
#PBS -q standby 
...
./exec_condorfilelist_V2.sh $INFILELIST $isPbPb $STARTFILE $ENDFILE $OUTPUTDIR $isReal

EOF

	chmod 744 PBS_jobs/PBS_shAll/PBS_${STARTFILE}to${ENDFILE}_${JobIndex}_V2.sh

	qsub PBS_jobs/PBS_shAll/PBS_${STARTFILE}to${ENDFILE}_${JobIndex}_V2.sh
	echo "PBS_jobs/PBS_shAll/PBS_${STARTFILE}to${ENDFILE}_${JobIndex}_V2.sh submitted"
