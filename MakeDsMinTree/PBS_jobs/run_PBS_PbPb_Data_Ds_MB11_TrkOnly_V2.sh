...
../submit_PBS_job_mutltifiles_V2.sh input_list/Ds_PbPb_Data_HIMB11_TrkOnly.lis  $isPbPb $FilePerJob /scratch/halstead/p/peng43/Ds_phikkpi/DsMinTreeV2/PbPb_Data/TrkOnly/Ds_PbPb_Data_HIMB11_TrkOnly   Ds_PbPb_Data_HIMB11_TrkOnly  $isReal
