...
for i in {0..5}
do
	../submit_PBS_job_mutltifiles.sh input_list/Ds_PbPb_MC_Prompt_Phi_pt${ptbins[i]}.lis  $isPbPb $FilePerJob /scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/PbPb_offMC/Ds_PbPb_MC_Prompt_Phi_pt${ptbins[i]} Ds_PbPb_MC_Prompt_Phi_pt${ptbins[i]}  $isReal

	../submit_PBS_job_mutltifiles.sh input_list/Ds_PbPb_MC_NonPrompt_Phi_pt${ptbins[i]}.lis  $isPbPb $FilePerJob /scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/PbPb_offMC/Ds_PbPb_MC_NonPrompt_Phi_pt${ptbins[i]} Ds_PbPb_MC_NonPrompt_Phi_pt${ptbins[i]}  $isReal

	../submit_PBS_job_mutltifiles.sh input_list/Ds_PbPb_MC_Prompt_f0_pt${ptbins[i]}.lis  $isPbPb $FilePerJob /scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/PbPb_offMC/Ds_PbPb_MC_Prompt_f0_pt${ptbins[i]} Ds_PbPb_MC_Prompt_f0_pt${ptbins[i]}  $isReal
 
	../submit_PBS_job_mutltifiles.sh input_list/Ds_PbPb_MC_NonPrompt_f0_pt${ptbins[i]}.lis  $isPbPb $FilePerJob /scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/PbPb_offMC/Ds_PbPb_MC_NonPrompt_f0_pt${ptbins[i]} Ds_PbPb_MC_NonPrompt_f0_pt${ptbins[i]}  $isReal
