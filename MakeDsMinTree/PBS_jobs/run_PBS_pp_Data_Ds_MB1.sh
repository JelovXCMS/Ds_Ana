...
../submit_PBS_job_mutltifiles.sh input_list/Ds_pp_Data_MB1.lis  $isPbPb $FilePerJob /scratch/halstead/p/peng43/Ds_phikkpi/DsMinTree/pp_Data/Ds_pp_Data_MB1 Ds_pp_Data_MB1  $isReal
