...
./MakeDsMinTree.exe "/scratch/halstead/p/peng43/Ds_phikkpi/temp/Dntuple_DsFinder_Dp_pp_mc.root_0.root" "/scratch/halstead/p/peng43/Ds_phikkpi/temp/DsMinTree_Dp_pp_mc_pt2.root" 0 0
